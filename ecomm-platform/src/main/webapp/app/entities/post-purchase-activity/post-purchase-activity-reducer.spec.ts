...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './post-purchase-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTPURCHASEACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTPURCHASEACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTPURCHASEACTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POSTPURCHASEACTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTPURCHASEACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTPURCHASEACTIVITY actions', async () => {
      const arg = 42666;
