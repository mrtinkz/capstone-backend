...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './scheduled-test-drive.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULEDTESTDRIVE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHEDULEDTESTDRIVE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHEDULEDTESTDRIVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SCHEDULEDTESTDRIVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULEDTESTDRIVE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHEDULEDTESTDRIVE actions', async () => {
      const arg = 42666;
