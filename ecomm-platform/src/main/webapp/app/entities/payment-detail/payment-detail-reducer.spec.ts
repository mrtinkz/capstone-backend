...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTDETAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTDETAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTDETAIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTDETAIL actions', async () => {
      const arg = 42666;
