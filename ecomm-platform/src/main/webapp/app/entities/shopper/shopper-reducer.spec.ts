...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './shopper.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHOPPER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHOPPER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHOPPER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SHOPPER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SHOPPER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHOPPER actions', async () => {
      const arg = 42666;
