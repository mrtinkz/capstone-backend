...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './financing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FINANCING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FINANCING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FINANCING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FINANCING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FINANCING actions', async () => {
      const arg = 42666;
