...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRICINGSUMMARY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRICINGSUMMARY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRICINGSUMMARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRICINGSUMMARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRICINGSUMMARY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRICINGSUMMARY actions', async () => {
      const arg = 42666;
