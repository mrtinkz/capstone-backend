...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTBLOB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCUMENTBLOB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCUMENTBLOB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOCUMENTBLOB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTBLOB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCUMENTBLOB actions', async () => {
      const arg = 42666;
