...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEOPTIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEOPTIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEOPTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEOPTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEOPTIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEOPTIONS actions', async () => {
      const arg = 42666;
