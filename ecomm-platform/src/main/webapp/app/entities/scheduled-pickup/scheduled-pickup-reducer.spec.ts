...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULEDPICKUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHEDULEDPICKUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHEDULEDPICKUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SCHEDULEDPICKUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULEDPICKUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHEDULEDPICKUP actions', async () => {
      const arg = 42666;
