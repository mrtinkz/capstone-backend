...
public class VehicleAsserts {
    ...
    public static void assertVehicleUpdatableFieldsEquals(Vehicle expected, Vehicle actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getDealerId()).as("check dealerId").isEqualTo(actual.getDealerId()))
            .satisfies(e -> assertThat(e.getPricingSummaryId()).as("check pricingSummaryId").isEqualTo(actual.getPricingSummaryId()))
            .satisfies(e -> assertThat(e.getVehicleOptionsId()).as("check vehicleOptionsId").isEqualTo(actual.getVehicleOptionsId()));
    }
